...
const ENDPOINT_KEY = "HelloWorldApi2";
...
describe("GET api test", async () => {
  ...
  before(async () => {
    ...
    // const apiEndpoint = "https:\/\/l7gd6c6gqg.execute-api.eu-west-3.amazonaws.com/hello2";
  ...
  it("verifies if response contains my username", async () => {
    ...
    assert.include(apiResponse.data.message, "victor");
  });
});
